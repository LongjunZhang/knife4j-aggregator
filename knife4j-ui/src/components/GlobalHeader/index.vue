<template>
  <div class="header knife4j-header-default" :class="headerClass">
    ...
    <div class="right">
      <!-- 版本选择器 -->
      <VersionSelector 
        class="action version-selector-wrapper"
...
import VersionSelector from "../VersionSelector/index.vue";
...
export default {
  ...
  setup(props, { emit }) {
    ...
    return {
      ...
      /**
       * 版本切换处理（具体逻辑在 VersionSelector 组件中实现）
       */
      onVersionChange(version) {
        console.log('版本已切换到 v' + version);
      },
    };
  },
  methods: {},
