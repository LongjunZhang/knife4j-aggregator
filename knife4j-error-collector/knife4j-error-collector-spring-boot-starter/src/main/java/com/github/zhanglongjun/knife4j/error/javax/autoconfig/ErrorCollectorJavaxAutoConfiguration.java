package com.github.zhanglongjun.knife4j.error.javax.autoconfig;
...
import com.github.zhanglongjun.knife4j.error.javax.extractor.BasePackageDetector;
import com.github.zhanglongjun.knife4j.error.extractor.StackExtractor;
import com.github.zhanglongjun.knife4j.error.javax.config.ErrorCollectorJavaxProperties;
import com.github.zhanglongjun.knife4j.error.javax.controller.ErrorDetailController;
import com.github.zhanglongjun.knife4j.error.javax.filter.JavaxErrorCollectorFilter;
import com.github.zhanglongjun.knife4j.error.javax.handler.GlobalExceptionHandler;
...
/**
 * Knife4j Error Collector 自动配置类 (Javax / Spring Boot 2.x)
...
@EnableConfigurationProperties(ErrorCollectorJavaxProperties.class)
public class ErrorCollectorJavaxAutoConfiguration {

    private final ErrorCollectorJavaxProperties properties;
    private ErrorDetailStore errorDetailStore;

    public ErrorCollectorJavaxAutoConfiguration(ErrorCollectorJavaxProperties properties) {
    ...
    public void init() {
        ...
        log.info("[ErrorCollector] Knife4j Error Collector (Javax) 已启动");
    ...
    public void destroy() {
        ...
        log.info("[ErrorCollector] Knife4j Error Collector (Javax) 已停止");
    }
    ...
    public FilterRegistrationBean<Filter> errorCollectorFilterRegistration() {
        ...
        registration.setFilter(new JavaxErrorCollectorFilter(properties));
